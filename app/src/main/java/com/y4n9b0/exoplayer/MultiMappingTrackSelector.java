 ...
 * renderer.
 */
public abstract class MultiMappingTrackSelector extends TrackSelector {
    ...
    public static final class MappedTrackInfo {
        ...
        private final @RendererCapabilities.AdaptiveSupport int[] rendererMixedMimeTypeAdaptiveSupports;
        private final @RendererCapabilities.Capabilities int[][][] rendererFormatSupports;
         ...
         * @param rendererMixedMimeTypeAdaptiveSupports The {@link RendererCapabilities.AdaptiveSupport} for mixed 
         *                                              MIME type
        ...
        /* package */ MappedTrackInfo(
                ...
                @RendererCapabilities.AdaptiveSupport int[] rendererMixedMimeTypeAdaptiveSupports,
         ...
         *
         * @param rendererIndex The renderer index.
         * @return The {@link MappedTrackInfo.RendererSupport}.
         */
        public @MappedTrackInfo.RendererSupport int getRendererSupport(int rendererIndex) {
            @MappedTrackInfo.RendererSupport int bestRendererSupport = RENDERER_SUPPORT_NO_TRACKS;
            @RendererCapabilities.Capabilities int[][] rendererFormatSupport = rendererFormatSupports[rendererIndex];
            for (@RendererCapabilities.Capabilities int[] trackGroupFormatSupport : rendererFormatSupport) {
                for (@RendererCapabilities.Capabilities int trackFormatSupport : trackGroupFormatSupport) {
         ...
         * @return The {@link MappedTrackInfo.RendererSupport}.
         */
        public @MappedTrackInfo.RendererSupport int getTypeSupport(@C.TrackType int trackType) {
            @MappedTrackInfo.RendererSupport int bestRendererSupport = RENDERER_SUPPORT_NO_TRACKS;
        ...
        /**
         * Returns the {@link RendererCapabilities.Capabilities} of the renderer for an individual track.
         *
         * @param rendererIndex The renderer index.
         ...
         * @return The {@link RendererCapabilities.Capabilities}.
         */
        public @RendererCapabilities.Capabilities int getCapabilities(int rendererIndex, int groupIndex,
                int trackIndex) {
         ...
         * @return The {@link RendererCapabilities.AdaptiveSupport}.
         */
        public @RendererCapabilities.AdaptiveSupport int getAdaptiveSupport(
        ...
        public @RendererCapabilities.AdaptiveSupport int getAdaptiveSupport(
            ...
            @RendererCapabilities.AdaptiveSupport int adaptiveSupport = RendererCapabilities.ADAPTIVE_SEAMLESS;
    ...
    public final TrackSelectorResult selectTracks(
        ...
        @RendererCapabilities.Capabilities int[][][] rendererFormatSupports =
                new int[rendererCapabilities.length + 1][][];
     ...
     * @param rendererFormatSupports The {@link RendererCapabilities.Capabilities} for ach mapped track, indexed by
     *     renderer, track group and track (in that order).
     * @param rendererMixedMimeTypeAdaptationSupport The {@link RendererCapabilities.AdaptiveSupport} for mixed MIME 
     *                                               type
     *     adaptation for the renderer.
     * @param mediaPeriodId The {@link MediaSource.MediaPeriodId} of the period for which tracks are to be
     *     selected.
     ...
     * @return An array containing {@link RendererCapabilities.Capabilities} for each track in the group.
     * @throws ExoPlaybackException If an error occurs determining the format support.
     */
    private static @RendererCapabilities.Capabilities int[] getFormatSupport(
            RendererCapabilities rendererCapabilities, TrackGroup group) throws ExoPlaybackException {
        @RendererCapabilities.Capabilities int[] formatSupport = new int[group.length];
     ...
     *
     * @param rendererCapabilities The {@link RendererCapabilities} of the renderers.
     * @return An array containing the {@link RendererCapabilities.AdaptiveSupport} for mixed MIME type adaptation 
     * for the
     *     renderer.
     * @throws ExoPlaybackException If an error occurs determining the adaptation support.
     */
    private static @RendererCapabilities.AdaptiveSupport int[] getMixedMimeTypeAdaptationSupports(
        ...
        @RendererCapabilities.AdaptiveSupport int[] mixedMimeTypeAdaptationSupport =
                new int[rendererCapabilities.length];
    ...
    @VisibleForTesting
    /* package */ static TracksInfo buildTracksInfo(TrackSelection[] selections, MappedTrackInfo mappedTrackInfo) {
